    ...
    async.series({
        ...
        getFin: function (cb) {
            ...
            _t.api(o, function (err, res) {
                ...
                name = (fin.financing_type_sysname == 'PERCENT')? 'report_merchant_factoring_percent.xlsx' : 'report_merchant_factoring_fixed.xlsx';
...
Model.prototype.report_altynfin = function (obj, cb) {
    if (arguments.length == 1) {
        cb = arguments[0];
        obj = {};
    }
