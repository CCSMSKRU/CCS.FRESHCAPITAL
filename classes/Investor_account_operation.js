...
Model.prototype.modify = function (obj, cb) {
    ...
    var _t = this;
    var client_object = _t.client_object || '';
    obj.operation_date = obj.operation_date || funcs.getDateMySQL();
...
//    }
//    var _t = this;
//    var investor_account_id = obj.investor_account_id;
//    if (isNaN(+investor_account_id)) return cb(new MyError('Не передан investor_account_id',{obj:obj}));
