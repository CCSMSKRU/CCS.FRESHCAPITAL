(function () {
    ...
    var formInstance = MB.Forms.getForm('form_merchant_financing_calendar_percent', formID);
    ...
    formInstance.lowerButtons = [
        ...
        },
        {
            ...
            handler: function(){
                ...
                formInstance.loader(true, 'Секундочку, отмечаем финансирование..');

                var o = {
                    command: 'onAttention',
                    object: 'merchant_financing',
                    params: {
                        id: data.merchant_financing_id
                    }
                };
                ...
                socketQuery(o, function(res){
                    ...
                    if(!res.code){
                        formInstance.loader(false, 'Секундочку, отмечаем финансирование..');
                    }else{
                        formInstance.loader(false, 'Секундочку, отмечаем финансирование..');
                    }
